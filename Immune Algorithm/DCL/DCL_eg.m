...
individuals = struct('fitness',zeros(1,M), 'concentration',zeros(1,M),...
    'excellence',zeros(1,M),'chrom',[]);

% step2 产生初始抗体群
individuals.chrom = initpop(M,length);
trace=[]; %记录每代最优个体适应度和平均适应度
...
% step3 抗体群多样性评价
     for i=1:M
         individuals.fitness(i) = fitness(individuals.chrom(i,:), length);
         % 抗体与抗原亲和度(适应度值）计算
...
% 画出配送中心选址图
% 城市坐标
city_coordinate=[1304,2312;3639,1315;4177,2244;3712,1399;3488,1535;...
